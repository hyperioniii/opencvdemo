 ...
 */
public class JavaCameraViewEx extends CameraBridgeViewBase implements PreviewCallback {

    private static final int MAGIC_TEXTURE_ID = 10;
    private static final String TAG = "JavaCameraViewEx";
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (JavaCameraViewEx.this) {
                    try {
                        JavaCameraViewEx.this.wait();
                    } catch (InterruptedException e) {
